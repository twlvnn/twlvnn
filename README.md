...
Translated:   11134 ( 99%)      49853 ( 99%)           63672
Fuzzy:           32 (  0%)        217 (  0%)             n/a
Untranslated:    20 (  0%)        178 (  0%)             n/a
Total:        11186             50248                  63672
...
./nickvision-tube-converter-app-bg.po        strings: total: 266	| 266t	0f	0u	| 100.0%t	0.0%f0.0%u
...
./tutanota-editor-bg.po                      strings: total: 1668	| 1668t	0f	0u	| 100.0%t	0.0%f0.0%u
...
./shortwave.po-ui.main.bg.po                 strings: total: 122	| 122t	0f	0u	| 100.0%t	0.0%f0.0%u
...
./papers.help-doc.main.bg.po                 strings: total: 507	| 503t	4f	0u	| 99.21104536489152%t0.7889546351084813%f	0.0%u
...
Преводите се правят в GitHub, GitLab, Weblate, Euphrase и Damned Lies (GNOME) с други сътрудници. Статистиките са извлечени чрез `translate-toolkit`. Използвам Gtranslator и `grep` за сканиране на терминология в po файлове, txt файл за запис на термините и Python скрипт за създаване на `poterminology` файл от ~3400 термина като преводна памет. С `pretranslate` автоматично превеждам повтарящи се фрази с паметния файл и бързо добавям нови преводи към обновени po файлове в изходния код.
